...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C00801();
        private VolumeProviderCompat mVolumeProvider;
        private int mVolumeType;

        class C00801 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C00801() {
            }
        ...
        class C00812 implements Callback {
            C00812() {
            }
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C00821();
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C00831();
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C00841();
