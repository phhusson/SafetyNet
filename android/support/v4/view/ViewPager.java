...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C01181());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C01181 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01181() {
            }
