...
public class AccountRecoveryUpdateResultCreator implements Creator<AccountRecoveryUpdateResult> {
    ...
    static void zza(AccountRecoveryUpdateResult accountRecoveryUpdateResult, Parcel parcel, int i) {
        int zzbe = zzb.zzbe(parcel);
        zzb.zzc(parcel, 1, accountRecoveryUpdateResult.version);
        zzb.zza(parcel, 2, accountRecoveryUpdateResult.error, false);
        zzb.zzJ(parcel, zzbe);
    }
