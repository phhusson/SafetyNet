...
public interface zzri extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzri {
        ...
        public static zzri asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface queryLocalInterface = obj.queryLocalInterface("com.google.android.gms.flags.IFlagProvider");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzri)) ? new zza(obj) : (zzri) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    init(com.google.android.gms.dynamic.zzd.zza.zzdk(data.readStrongBinder()));
