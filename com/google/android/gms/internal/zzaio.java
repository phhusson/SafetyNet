...
public final class zzaio {
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        if (obj != null) {
            if (obj instanceof zzain) {
                ...
                if (str != null) {
                    stringBuffer2.append(stringBuffer).append(zzkn(str)).append(" <\n");
                    stringBuffer.append("  ");
                }
                    ...
                    if (name3.startsWith("set")) {
                        ...
                        try {
                            if (((Boolean) cls.getMethod("has" + substring, new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                                try {
                                    zza(substring, cls.getMethod(Endpoints.ENDPOINT_GET + substring, new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
            ...
            if (obj instanceof String) {
                stringBuffer2.append("\"").append(zzbW((String) obj)).append("\"");
            } else if (obj instanceof byte[]) {
                zza((byte[]) obj, stringBuffer2);
            } else {
                stringBuffer2.append(obj);
            }
            stringBuffer2.append(Csv.NEWLINE);
        }
    }
    ...
    public static <T extends zzain> String zzf(T t) {
        if (t == null) {
            return "";
        }
    ...
    private static String zzkn(String str) {
        StringBuffer stringBuffer = new StringBuffer();
