...
public class zzam implements Creator<Taglines> {
    static void zza(Taglines taglines, Parcel parcel, int i) {
        int zzbe = zzb.zzbe(parcel);
        Set set = taglines.zzbCc;
        if (set.contains(Integer.valueOf(1))) {
            zzb.zzc(parcel, 1, taglines.mVersionCode);
        }
        if (set.contains(Integer.valueOf(2))) {
            zzb.zza(parcel, 2, taglines.zzbCN, i, true);
        }
        if (set.contains(Integer.valueOf(3))) {
            zzb.zza(parcel, 3, taglines.mValue, true);
        }
        zzb.zzJ(parcel, zzbe);
    }
    ...
    public Taglines zziR(Parcel parcel) {
        String str = null;
        ...
        if (parcel.dataPosition() == zzbd) {
            return new Taglines(hashSet, i, defaultMetadataImpl, str);
        }
        throw new zza.zza("Overread allowed size end=" + zzbd, parcel);
    }

    public Taglines[] zzmL(int i) {
        return new Taglines[i];
    }
}
