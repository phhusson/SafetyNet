...
public interface zza extends IInterface {
    ...
    public static abstract class zza extends Binder implements zza {
        ...
        public static zza zzgs(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 2:
                    ...
                    PlayLoggerContext createFromParcel = data.readInt() != 0 ? PlayLoggerContext.CREATOR.createFromParcel(data) : null;
                    if (data.readInt() != 0) {
                        zzjY = LogEvent.CREATOR.zzjY(data);
                    }
                    zza(readString2, createFromParcel, zzjY);
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.playlog.internal.IPlayLogService");
