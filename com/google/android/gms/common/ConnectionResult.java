...
public final class ConnectionResult implements SafeParcelable {
    ...
    public static final ConnectionResult zzapJ = new ConnectionResult(0);
    ...
    public boolean equals(Object o) {
        ...
        return this.zzamh == connectionResult.zzamh && zzw.equal(this.mPendingIntent, connectionResult.mPendingIntent) && zzw.equal(this.zzapK, connectionResult.zzapK);
    }
    ...
    public boolean hasResolution() {
        return (this.zzamh == 0 || this.mPendingIntent == null) ? false : true;
    }

    public int hashCode() {
        return zzw.hashCode(Integer.valueOf(this.zzamh), this.mPendingIntent, this.zzapK);
    }
    ...
    public String toString() {
        return zzw.zzC(this).zzh("statusCode", getStatusString(this.zzamh)).zzh("resolution", this.mPendingIntent).zzh("message", this.zzapK).toString();
    }
