...
class SnetSharedPreferences {
    ...
    long lastEventLogTimestampMs() {
        return this.mPreferences.getLong(SNET_EVENT_LOG_LAST_TIMESTAMP_MS, -1);
    }
    ...
    long lastIdleModeRunTimestampMs() {
        return this.mPreferences.getLong(LAST_IDLE_MODE_RUN_TIMESTAMP_MS, -1);
    }
    ...
    long lastNormalModeRunTimestampMs() {
        return this.mPreferences.getLong(LAST_NORMAL_MODE_RUN_TIMESTAMP_MS, -1);
    }
