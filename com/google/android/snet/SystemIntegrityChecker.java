...
import com.google.android.snet.nano.IdleLogs.SystemIntegrityRequest;
import com.google.android.snet.nano.IdleLogs.SystemIntegrityResponse;
...
class SystemIntegrityChecker {
    ...
    private static final String TAG = SystemIntegrityChecker.class.getCanonicalName();
    private final Context mContext;
    private final SnetFilesDataStore mDataStore = new SnetFilesDataStore(this.mContext);
    ...
    SystemIntegrityResponse httpRequest(SystemIntegrityRequest requestProto) {
        ...
        byte[] responseBytes = Utils.httpRequest(this.mGBundle.getSicServerUrl(), MessageNano.toByteArray(requestProto), 30000, 30000);
